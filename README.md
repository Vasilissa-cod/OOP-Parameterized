...
Можно использовать тот же проект OOP, с которым работали на занятии.

### 1. Доделайте то, что делали в классе.

### 2. Сделайте класс MainPage для хранения информации о веб-странице.
...
### 3. В функции main создайте 3 разных объекта класса MainPage с помощью 3-х разных конструкторов и выполните проверку размера для каждого.
